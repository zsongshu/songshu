---
title: "实例：利用 sampling_complete 进行代码评论"
source: "实例：利用 sampling_complete 进行代码评论.docx"
type: docx
tags: ["docx"]
path: "777-AI-技术"
created: 2026-07-03
...
# 实例：利用 sampling_complete 进行代码评论

![[实例：利用 sampling_complete 进行代码评论-b7902302.docx]]
...
用户要求 Server 对一段代码进行风格和可读性评论。
  ...
  **MCP Client (AI 编辑器)**   用户在代码中选中一段代码，并调用 Server 的 **Tool**：analyze_code_style(snippet)。                     Client 将请求发送给 Server，要求执行复杂的分析。
