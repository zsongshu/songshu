...
5. 将拆分的文本块统一存入 [向量数据库](https://guangzhengli.com/blog/zh/vector-database) 中。
6. 将用户问题转化为向量，然后通过向量数据库进行检索，得到最相关的文本段落。（需要注意的是，这里的检索并不是传统数据库的模糊匹配或者倒排索引，而是基于语义化的搜索能力，所以检索出的文本才能回答用户问题，详细请看另外一篇博客 [向量数据库](https://guangzhengli.com/blog/zh/vector-database)
...
student_\_description=小王是北京大学计算机科学专业的二年级学生，绩点为 3.8 GPA。他的编程很厉害，是该大学机器人俱乐部的活跃成员。他希望在毕业后追求人工智能方面的工作。_
...
student\_custom\_functions = \[
{
'name': 'extract\_student\_info',
...
* <https://a16z.com/how-are-consumers-using-generative-ai>
    ...
    Created at: 2026-02-28T17:33:26+08:00
    Updated at: 2026-02-28T17:34:33+08:00
